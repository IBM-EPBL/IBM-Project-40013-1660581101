...
app.config['MAIL_DEFAULT_SENDER'] = 'balaji1649417@gmail.com'
mail = Mail(app)
cors = CORS(app)
...
print()
try:
    conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=1bbf73c5-d84a-4bb0-85b9-ab1a4348f4a4.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud;PORT=32286;Security=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=gkf87001;PWD=CXtQLAGZ06fD0fhC;",   "", "")
